...
case class MatchBlockAST(expr: ExprAST, cases: Seq[(ExprAST, ParserAST)], els: Option[ParserAST]) extends ParserAST
...
case class BlockWithCaseAST(body: ParserAST, expr: ExprAST) extends ParserAST
