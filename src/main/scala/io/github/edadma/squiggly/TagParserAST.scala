...
case class MethodExpr(expr: ExprAST, method: String) extends ExprAST
...
case class ForAST(index: Option[(TagParserIdent, Option[TagParserIdent])], expr: ExprAST) extends SimpleBlockAST
